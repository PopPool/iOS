//
//  BookMarkPopUpViewTypeModalView.swift
//  Poppool
//
...
final class BookMarkPopUpViewTypeModalView: UIView {
    ...
    let sortedSegmentControl: PPSegmentedControl = {
        let control = PPSegmentedControl(type: .base, segments: ["크게보기","모아서보기"])
        return control
    }()
...
// MARK: - SetUp
private extension BookMarkPopUpViewTypeModalView {
